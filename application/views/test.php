            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <nav aria-label="breadcrumb" class="breadcumb--con text-center">
                        <h2 class="w-text title wow fadeInUp" data-wow-delay="0.2s">Filosofia</h2>
...
<section class="about-us-area section-padding-100 clearfix">
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-12 col-lg-4 offset-lg-1 col-md-10 offset-md-1">
                <div class="welcome-meter fadeInUp" data-wow-delay="0.7s">
                    <img src="<?=base_url('resources/landingpage/img/images/colectivoLogo.jpg');?>"  alt="">
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6 offset-lg-0 col-md-10 offset-md-1">
                <div class="who-we-contant mt-s">
                    ...
                    <h4 class="fadeInUp" data-wow-delay="0.3s">MISIÓN.</h4>
                    <p class="filosofia-text" data-wow-delay="0.4s">Fomentar la importancia de la
                                                              cultura Hñöhñö a través de los
                                                              medios digitales. Así como impulsar
                                                              su enseñanza para la preservación
                                                              de la misma y proteger los derechos
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 offset-lg-1 col-md-10 offset-md-1">
                <div class="who-we-contant mt-s">
                    <div class="sect-icon text-left fadeInUp" data-wow-delay="0.2s">
                        <img src="img/svg/section-icon-2.svg" alt="">
                    </div>
                    <h4 class="fadeInUp" data-wow-delay="0.3s">VISIÓN.</h4>
                    <p class="filosofia-text" data-wow-delay="0.4s">Ser líder en la Cultura Hñöhñö a
                                                              nivel global a través de la difusión
                                                              en los medios digitales y tener más
                                                              acercamiento hacia las comunidades
                                                              indígenas.</p>
            ...
            <div class="col-12 col-lg-4 offset-lg-1 col-md-10 offset-md-1">
                <div class="welcome-meter fadeInUp" data-wow-delay="0.7s">
                    <img src="<?=base_url('resources/landingpage/img/images/jamodi.jpg');?>"  alt="">
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-4 offset-lg-1 col-md-10 offset-md-1">
                <div class="who-we-contant">
                    ...
                    <h4 class=" fadeInUp" data-wow-delay="0.3s">VISIÓN</h4>
                    <p class="filosofia-text" data-wow-delay="0.5s">.</p>
            ...
            <div class="col-12 col-lg-6 mt-s no-padding-right">
                <div class="welcome-meter fadeInUp" data-wow-delay="0.7s">
                    <img class="img-responsive center-block" alt="" src="img/core-img/about3.png">
