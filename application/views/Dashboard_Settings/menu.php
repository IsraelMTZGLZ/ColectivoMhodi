      ...
      <div class="overlay-panel vertical-align overlay-background">
        <div class="vertical-align-middle">
          ...
          <div class="site-menubar-info">
            ...
            <p class="site-menubar-email"><a href="https://getbootstrapadmin.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4f222e2c27262b2a3c2628210f28222e2623612c2022">[email&#160;protected]</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <ul class="site-menu" data-plugin="menu">
          ...
          <li class="site-menu-item has-sub">
            ...
            <ul class="site-menu-sub">
              ...
              <li class="site-menu-item">
                <a href="layouts/menubar-open.html">
                  <span class="site-menu-title">Menubar Open</span>
                </a>
              </li>
              <li class="site-menu-item">
                <a href="layouts/menubar-push.html">
