    ...
    <section class="what-we-do section-padding-100">
      <div class="container">
        ...
        <div class="clearfix"></div>
         <div class="outer">
         <!--Logo-->
            <div class="inner-circle"><a href="#"><img class="phone" src="<?=base_url('resources/landingpage/img/core-img/app-design.png');?>" alt="image"></a></div>
            ...
            <div class="row clearfix">
              <!--Left Column-->
               <div class="left-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="service-box-three">
                      <div class="inner-box">
                          <div class="icon-box"><img src="img/icons/w1.png" alt=""></div>
                          <h3><a href="services-single.html">Insurance Planning</a></h3>
                  ...
                  <div class="service-box-three">
                      <div class="inner-box">
                          <div class="icon-box"><img src="img/icons/w2.png" alt=""></div>
                  ...
                  <div class="service-box-three">
                      <div class="inner-box">
                          <div class="icon-box"><img src="img/icons/w3.png" alt=""></div>
              ...
              <div class="right-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="service-box-four">
                      <div class="inner-box">
                          <div class="icon-box"><img src="img/icons/w4.png" alt=""></div>
                          <h3><a href="services-single.html">Commodities Training</a></h3>
                          <div class="text"> Iterative approaches to corporate strategy foster collaborative thinkin </div>
                      </div>
                  </div>
                  ...
                  <div class="service-box-four">
                      <div class="inner-box">
                          <div class="icon-box"><img src="img/icons/w5.png" alt=""></div>
                          <h3><a href="services-single.html">Mutual Funds</a></h3>
                          <div class="text"> Iterative approaches to corporate strategy foster collaborative thinkin </div>
                      </div>
                  </div>
                  ...
                  <div class="service-box-four">
                      <div class="inner-box">
                          <div class="icon-box"><img src="img/icons/w6.png" alt=""></div>
                          <h3><a href="services-single.html">Wealth Management</a></h3>
                          <div class="text"> Iterative approaches to corporate strategy foster collaborative thinkin </div>
                      </div>
                  </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-5 offset-lg-1 col-md-10 offset-md-1">
                    <div class="who-we-contant">
                        ...
                        <h4 class=" fadeInUp" data-wow-delay="0.3s">Introducing the most powerful App Template on the market.</h4>
                ...
                <div class="col-12 col-lg-6 mt-s no-padding-right">
                    <div class="welcome-meter fadeInUp" data-wow-delay="0.7s">
                        <img class="img-responsive center-block" alt="" src="<?=base_url('resources/landingpage/img/core-img/about3.png');?>">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="who-we-contant mb-30">
                        <div class="sect-icon text-left fadeInUp" data-wow-delay="0.2s">
                            <img src="<?=base_url('resources/landingpage/img/svg/section-icon-5.svg');?>" alt="">
                        </div>
                        <h4 class="fadeInUp" data-wow-delay="0.3s">Build, edit and create a custom test framework in minutes.</h4>
                        <p class="fadeInUp" data-wow-delay="0.4s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at dictum risus, non suscipit arcu. Quisque aliquam posuere tortor, sit amet convallis nunc scelerisque in.</p>
                        <p class="fadeInUp" data-wow-delay="0.5s">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo quo laboriosam, dolorum ducimus aliquam consequuntur!</p>
        ...
        <div class="container">
            ...
            <div class="section-heading text-center">
                ...
                <div class="sect-icon justify-content-center fadeInUp" data-wow-delay="0.2s">
                    <img src="<?=base_url('resources/landingpage/img/svg/section-icon-3.svg');?>" alt="">
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="service_icon">
                            <img src="<?=base_url('resources/landingpage/img/features/1.png');?>" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=base_url('resources/landingpage/img/features/2.png');?>" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.4s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=base_url('resources/landingpage/img/features/3.png');?>" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.5s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=base_url('resources/landingpage/img/features/4.png');?>" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.6s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=base_url('resources/landingpage/img/features/5.png');?>" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.7s">
                        <!-- Icon -->
                        <div class="service_icon">
                            <img src="<?=base_url('resources/landingpage/img/features/6.png');?>" alt="">
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6 col-xs-12">
                    <div class="who-we-contant">
                        <div class="sect-icon text-left fadeInUp" data-wow-delay="0.2s">
                                <img src="<?=base_url('resources/landingpage/img/svg/section-icon-11.svg');?>" alt="">
                            </div>
                            ...
                            <a class="btn info-btn mt-30 fadeInUp mr-15" data-wow-delay="0.6s" href="#">
                                <img src="<?=base_url('resources/landingpage/img/icons/google-play.png');?>" alt="">Download Now
                            </a>
                            <a class="btn info-btn mt-30 fadeInUp" data-wow-delay="0.6s" href="#">
                                <img src="<?=base_url('resources/landingpage/img/icons/windows.png');?>" alt="">Download Now
                            </a>
                    </div>
                </div>
    ...
    <section class="features section-padding-100">
        <div class="container">
            <div class="section-heading text-center">
                ...
                <div class="sect-icon justify-content-center fadeInUp" data-wow-delay="0.2s">
                     <img src="<?=base_url('resources/landingpage/img/svg/section-icon-4.svg');?>" alt="">
                </div>
                <h2 class="fadeInUp" data-wow-delay="0.3s">Our Ecommerce App</h2>
                <p class="fadeInUp" data-wow-delay="0.4s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis accumsan nisi Ut ut felis congue nisl hendrerit commodo.</p>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="services-column col-lg-6 col-md-12 col-xs-12">
                    ...
                    <div class="services-block-four">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="<?=base_url('resources/landingpage/img/svg/feature1.svg');?>" alt="">
                            </div>
                    ...
                    <div class="services-block-four">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="<?=base_url('resources/landingpage/img/svg/feature2.svg');?>" alt="">
                            </div>
                    ...
                    <div class="services-block-four" style="margin-bottom:0">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="<?=base_url('resources/landingpage/img/svg/feature3.svg');?>" alt="">
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 offset-lg-0 col-md-8 offset-md-2 col-sm-10 offset-sm-1">
                    <img src="<?=base_url('resources/landingpage/img/core-img/0faq.png');?>" alt="" class="center-block img-responsive">
                </div>
                <div class="col-12 col-lg-6 col-md-12">
                    <div class="dream-faq-area mt-s ">
                        <dl style="margin-bottom:0">
                            <!-- Single FAQ Area -->
                            <dt class="wave fadeInUp" data-wow-delay="0.2s">What are the objectives of this App?</dt>
                            ...
                            <!-- Single FAQ Area -->
                            <dt class="wave fadeInUp" data-wow-delay="0.5s">how may I take part in and purchase this App?</dt>
                            <dd>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore omnis quaerat nostrum, pariatur ipsam sunt accusamus enim necessitatibus est fugiat, assumenda dolorem, deleniti corrupti cupiditate ipsum, dolorum voluptatum esse error?</p>
                            </dd>
                        </dl>
                ...
                <div class="col-12 col-md-10 col-xs-10 offset-xs-1">
                    <div class="client_slides owl-carousel">
                        ...
                        <div class="single-testimonial text-center">
                            ...
                            <div class="testimonial-description">
                                <div class="testimonial_text">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et delectus, nam repudiandae repellat similique excepturi id placeat molestias consequuntur, laudantium dolorem nesciunt sit molestiae.</p>
                                </div>
                                <!-- Admin Text -->
                                <div class="admin_text">
                                    <h5>Jebin Khan</h5>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-area fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="#" class="btn info-btn mt-15">Read Details</a>
                        </div>
                    </div>
                </div>
